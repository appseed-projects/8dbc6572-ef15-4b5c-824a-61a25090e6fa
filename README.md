...
- Timestamp: `2022-06-15 09:38`
- Build ID: `8dbc6572-ef15-4b5c-824a-61a25090e6fa`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/8dbc6572-ef15-4b5c-824a-61a25090e6fa.git
$ cd 8dbc6572-ef15-4b5c-824a-61a25090e6fa
```
